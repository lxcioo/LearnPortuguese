...
export default function SettingsModal() {
  const { isDarkMode, theme, themeSetting, setThemeSetting, gender, setGender } = useTheme();
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.card, { backgroundColor: isDarkMode ? '#222' : '#f9f9f9' }]}>
            ...
            <View style={styles.genderRow}>
              <TouchableOpacity
                style={[styles.genderBtn, themeSetting === 'light' && styles.genderBtnActive]}
                onPress={() => setThemeSetting('light')}
              >
                <Text style={[styles.genderLabel, themeSetting === 'light' ? { color: '#fff' } : { color: currentColors.text }]}>Hell</Text>
              </TouchableOpacity>

              <TouchableOpacity
                style={[styles.genderBtn, themeSetting === 'dark' && styles.genderBtnActive]}
                onPress={() => setThemeSetting('dark')}
              >
                <Text style={[styles.genderLabel, themeSetting === 'dark' ? { color: '#fff' } : { color: currentColors.text }]}>Dunkel</Text>
              </TouchableOpacity>

              <TouchableOpacity
                style={[styles.genderBtn, themeSetting === 'system' && styles.genderBtnActive]}
                onPress={() => setThemeSetting('system')}
              >
                <Text style={[styles.genderLabel, themeSetting === 'system' ? { color: '#fff' } : { color: currentColors.text }]}>System</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
